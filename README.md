# SilverStripe module for list of videos from YouTube for specified channel.

Shows list of videos from YouTube for specified channel.
...
## Installation
```
composer require amolswnz/youtube-video-list
```
